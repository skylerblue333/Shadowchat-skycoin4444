...
const useSeedPhraseBackup: any = (..._args: any[]) => new Proxy(() => ({}), { get: () => (() => ({ data: undefined, isLoading: false, isError: false, error: null, mutate: () => {}, mutateAsync: async () => ({}), isPending: false })) });
...
const { Terminal, Loader2 } = (__ns_lucide_react_1 as any);
