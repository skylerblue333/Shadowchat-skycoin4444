...
const BillingManagement: React.FC = () => {
  const { data: planData, isLoading: isPlanLoading, error: planError } = trpc.billing.getPlan.useQuery();
  const { data: paymentData, isLoading: isPaymentLoading, error: paymentError } = trpc.billing.getPaymentMethod.useQuery();
  const { data: historyData, isLoading: isHistoryLoading, error: historyError } = trpc.billing.getBillingHistory.useQuery();
