...
const CommunityModerationActions: React.FC = () => {
  const { data: actions, isLoading, isError, error, refetch } = api.moderation.getActions.useQuery();

  const updateActionMutation = api.moderation.updateAction.useMutation({
    onSuccess: () => {
