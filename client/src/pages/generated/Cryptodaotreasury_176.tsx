...
const { DollarSign, Wallet, Banknote, TrendingUp, Clock } = (__ns_lucide_react_1 as any);
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import * as __ns_recharts_2 from 'recharts';
const { ResponsiveContainer, PieChart, Pie, Cell, Tooltip, Legend } = (__ns_recharts_2 as any);
